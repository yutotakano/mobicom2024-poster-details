...
<div class="flex flex-wrap gap-4 w-full">
  <div class="flex-1 min-w-[16rem]">
    <h3 class="mb-3">Elastic Kubernetes Service (EKS) with Fargate instances</h3>
    <p>
  ...
  <div class="flex-1 min-w-[16rem]">
    <h3 class="mb-3">EKS with Elastic Compute Cloud (EC2) instances</h3>
    <p>
  ...
  <div class="flex-1 min-w-[16rem]">
    <h3 class="mb-3">Self-managed Kubernetes on EC2 instances</h3>
    <p>
